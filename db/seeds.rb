...
Rider.create(first_name: 'Mateo', last_name: 'Posada', email: 'rider1@gmail.com', status: 'ACTIVE', country: 'Colombia', state: 'Antioquia', city: 'Medellin', age: 28, current_latitude: 6.229394646529697, current_longitude: -75.59675008337844 )
Rider.create(first_name: 'Juliana', last_name: 'Vargas', email: 'rider2@gmail.com', status: 'ACTIVE', country: 'Colombia', state: 'Antioquia', city: 'Envigado', age: 31, current_latitude: 6.163248030703451,  current_longitude: -75.57207597297769 )
Rider.create(first_name: 'Vannesa', last_name: 'Maldonado', email: 'rider3@gmail.com', status: 'ACTIVE', country: 'Colombia', state: 'Antioquia', city: 'Medellin', age: 32, current_latitude: 6.244852174678537, current_longitude: -75.58443000041845 )
